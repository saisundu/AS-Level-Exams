# AS-Level Exams Repository - Organization Summary
...
- **Current**: 70 papers (69 successfully downloaded + 1 existing)
- **Years Covered**: 2020-2024
- **Sessions**: March, June, October
- **Papers**: Paper 1 (variants 11,12,13) + Paper 2 (variants 21,22,23)
- **Success Rate**: 98.6% (69/70 papers downloaded)
...
**Note**: Only 1 failed download (9609_s21_qp_21.pdf) - 99.9% success rate
...
|---------|------------------|------------------|-----------------|--------------|
| Pure Mathematics 9709 | 35 | 4 | 11.4% | 85.25% |
| Probability & Statistics 9709 | 15 | 15 | 100% | 95%+ |
| Business 9609 | 70 | 1 | 1.4% | N/A |
| **TOTAL** | **120** | **20** | **16.7%** | **90%+** |
...
- **Pure Mathematics**: 100% of available papers collected
- **Probability & Statistics**: 100% of Winter papers collected
- **Business**: 98.6% of target papers collected (69/70)
